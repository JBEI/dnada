<template>
  <v-container fluid>
    <v-card class="ma-3 pa-3">
      ...
      <v-card-text>
        <div class="my-4">
          <div class="subheading text--lighten-3">Full Name</div>
          <div
        ...
        <div class="my-3">
          <div class="subheading text--lighten-3">Email</div>
          <div
            class="title primary--text text--darken-2"
...
export default class UserProfile extends Vue {
  ...
  public goToEdit() {
    this.$router.push('/main/profile/edit').catch((err) => {
      throw new Error(`Problem handling something: ${err}.`);
    });
  }

  public goToPassword() {
    this.$router.push('/main/profile/password').catch((err) => {
      throw new Error(`Problem handling something: ${err}.`);
    });
  }
}
